...
# Thread ID
thread_id = "thread_AkAtgza4tHYZe4bIw4dJuY5B"
...
if __name__ == "__main__":
    ...
    user_message = "please create a sequence diagram using the eraser io syntax formatting for a barbershop that onboards new customers for a haircut. Only return the diagram eraser io syntax and nothing else."
    add_message_to_thread(thread_id, user_message)
    print(f"Added message to thread: {user_message}")
    
    # Create and start a run
    run = create_and_run_thread(thread_id, assistant_id)
