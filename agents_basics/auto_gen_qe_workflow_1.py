...
def main():
    ...
    human.initiate_chat(sdet, message=f"Create an IEEE 829 test plan based on these requirements:\n{ba_response}")
    sdet_response = sdet.last_message()["content"]
    print("\nSDET's Test Plan:")
    print(sdet_response)

    # QE Lead reviews and provides feedback
    human.initiate_chat(qe_lead, message=f"Review the following Jira Story and Test Plan. Provide feedback and a final assessment.\n\nJira Story:\n{ba_response}\n\nTest Plan:\n{sdet_response}")
